...
def test_black_box(model_label, model, test_loader, epsilon, device):
    ...
    results_nes.append({
            ...
            'correct_adv_accuracy': nes_metrics_1.correct_adv_accuracy,
            'status': 'ok'})
    ...
    results_gen.append({
           ...
           'correct_adv_accuracy': gen_metrics_1.correct_adv_accuracy,
           'status': 'ok'})
    ...
    results_square.append({
            ...
            'correct_adv_accuracy': square_metrics_1.correct_adv_accuracy,
            'status': 'ok'})
