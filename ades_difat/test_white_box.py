...
def test_white_box(path_name, model, test_loader, device):
...
if __name__ == "__main__":
    ...
    for model_item in models_names:
        ...
        path_name = f"test_white_box_results/{model_label}_white_box_results_1000.json"

        test_white_box(path_name, model, test_loader, device)
